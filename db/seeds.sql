...
insert into users (username, password, firstName, lastName, city, state, country, description, createdAt, updatedAt)
values ('brian.cocherell@gmail.com', 'password', 'Brian', 'Cocherell', 'Cleveland', 'OH', 'US', 'Cool Guy', '2018-02-16', '2018-02-16'),
('peterburnshicks@gmail.com', 'password', 'Peter', 'Burns', 'Cleveland', 'OH', 'US', 'Cool Guy', '2018-02-16', '2018-02-16'),
('mockbee1000@gmail.com', 'password', 'Jon', 'Mockbee', 'Cleveland', 'OH', 'US', 'Cool Guy', '2018-02-16', '2018-02-16'),
('joemalov@gmail.com', 'password', 'Joe', 'Malovasic', 'Cleveland', 'OH', 'US', 'Cool Guy', '2018-02-16', '2018-02-16');
